...
C     Grid seems to be valid.
      CLOSE (NtOpFl)
      IF (CharOutForm.EQ.'d'.OR.CharOutForm.EQ.'u' .or. 
     >    CharOutForm.EQ.'s' ) THEN
...
C
     ...
     &                   Index,Index2)
          END DO
        ELSEIF (CharOutForm.EQ.'s') THEN
C         Write triangulation to .DAT file.
          CALL FLGOUT (LsOutVvr,FlsOutVv(1),MOutVvr,
     &                 MLmt,LmtNde,MBnd,NdxLBnNd,NmNghFNd,NmNghLNd,
     &                 NvNmBn,IBndType,MNde,XNode,YNode,
     &                 MVvr,NFrmNde(1,1),NghVvr(1,1),
...
C
     ...
     &                MBnd,NdxLBnNd,IBndType)
C
          CALL TRISET2D (LsOutVvr,FlsOutVv,MOutVvr,
     &                 LsFlgVvr,NtOpFl,Code,Version,
     &                 MVvr,NFrmNde,NghVvr,
     &                 XVvr,YVvr,RadVvr,
     &                 MNde,XNode,YNode,
